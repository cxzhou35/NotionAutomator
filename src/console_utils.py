...
from .base_utils import default_dotdict, dotdict  # noqa: F401
...
os.environ["PYTHONBREAKPOINT"] = (
    "src.console_utils.set_trace"  # won't work without abs imports
)
...
def cached_log_stream(filename: str, mode="w", encoding="utf-8"):
    from ...misc.io_helper import pathmgr # type: ignore
...
use_std_tqdm = os.environ.get("USE_STD_TQDM", "").lower() == "true"
if use_std_tqdm:
    tqdm = std_tqdm
else:
    tqdm = tqdm_rich
